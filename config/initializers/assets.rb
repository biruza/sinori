...
Rails.application.config.assets.precompile += %w( angle/themes/theme-f.css )
Rails.application.config.assets.precompile += %w( questions.css )
Rails.application.config.assets.precompile += %w( questions.js )
Rails.application.config.assets.precompile += %w( questions1.css )
Rails.application.config.assets.precompile += %w( questions1.js )
